...
export default function NazimLayout({ children }: { children: React.ReactNode }) {
    ...
    <div className="flex h-screen bg-slate-100">
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col border-r border-slate-800">
        ...
        <nav className="flex-1 p-4 flex flex-col gap-1 text-sm font-medium">
          <Link href="/nazim" className="px-3 py-2 rounded-lg hover:bg-slate-800 text-slate-200 transition">
            📊 Center Overview
          </Link>
          <Link href="/nazim/finance" className="px-3 py-2 rounded-lg hover:bg-slate-800 text-slate-200 transition">
            💰 Zakat & Finance Ledger
          </Link>
        </nav>
